...
revisited in Dec 2018 to overlay on drifter tracks in CC Bay so I made a function uvmodel_function.py
"""
...
urlname=open("ctrl_uvmodel.csv", "r").readlines()[0][58:-1]
...
gbox=[-70.8,-70.,41.5,42.0]#float(open("ctrl_uvmodel.csv", "r").readlines()[5][32:-1])
##############################################################
...
plt.savefig(urlname+'_vectors'+str(TIME)[0:10]+'_'+str(TIME)[11:16]+'.png')
